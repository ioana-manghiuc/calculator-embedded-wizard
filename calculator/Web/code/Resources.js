...
D.Ae={bitmap:null,FrameDelay:0,NoOfFrames:1,FrameSize:B.wf,FO:false,CI:false,Di:function(
...
this.FrameSize=frameSize;this.FrameDelay=frameDelay;this.FO=true;this.CI=(!!this.
bitmap&&(this.FrameDelay>0))&&(this.NoOfFrames>1);},JV:function(C){throw new Error(
AG);},Update:function(){},_Init:function(aArg){B.Core.D8._Init.call(this,aArg);this.
__proto__=D.Ae;this.AU(aArg);},_Done:function(){this.Di();this.__proto__=B.Core.
D8;B.Core.D8._Done.call(this);},_className:"Resources::Bitmap"};D.A_={font:null,
Leading:0,Descent:0,Ascent:0,Di:function(){this.Nr();},AU:function(aArg){this.Nt(
aArg);},Nr:function(){if(!this.font)return;var handle=this.font;B.aal(handle);this.
font=null;this.Ascent=0;this.Descent=0;this.Leading=0;},Nt:function(aFontResource
...
descent;this.Leading=leading;},JQ:function(aFlowString){if(!this.font)return 0;var
handle=this.font;var advance=0;advance=B.aav(handle,aFlowString);return advance;
},LQ:function(aString,aOffset,aWidth,aMaxNoOfRows,aBidi){if(aOffset<0)aOffset=0;
...
function(aArg){B.Core.D8._Init.call(this,aArg);this.__proto__=D.A_;this.AU(aArg);
},_Done:function(){this.Di();this.__proto__=B.Core.D8;B.Core.D8._Done.call(this);
},_className:"Resources::Font"};
D._Init=function(){D.Ae.__proto__=B.Core.D8;D.A_.__proto__=B.Core.D8;};D._ReInit=
function(){};D.Cv=function(E){};return D;})();
