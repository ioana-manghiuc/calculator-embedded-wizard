...
D.Ae={bitmap:null,FrameDelay:0,NoOfFrames:1,FrameSize:B.wf,FO:false,CI:false,CK:function(
){if(!this.bitmap)return;var handle=this.bitmap;B._FreeBitmap(handle);this.bitmap=
null;this.FrameSize=AI;this.FrameDelay=0;this.NoOfFrames=1;this.CI=false;},AN:function(
...
AG);},Update:function(){},_Init:function(aArg){B.Core.D9._Init.call(this,aArg);this.
__proto__=D.Ae;this.AN(aArg);},_Done:function(){this.CK();this.__proto__=B.Core.
D9;B.Core.D9._Done.call(this);},_className:"Resources::Bitmap"};D.Bb={font:null,
Leading:0,Descent:0,Ascent:0,CK:function(){this.Np();},AN:function(aArg){this.Nr(
...
);return result;},Gq:function(aString,aOffset,aCount){if(aOffset<0)aOffset=0;if(
...
function(aArg){B.Core.D9._Init.call(this,aArg);this.__proto__=D.Bb;this.AN(aArg);
},_Done:function(){this.CK();this.__proto__=B.Core.D9;B.Core.D9._Done.call(this);
},_className:"Resources::Font"};
D._Init=function(){D.Ae.__proto__=B.Core.D9;D.Bb.__proto__=B.Core.D9;};D._ReInit=
