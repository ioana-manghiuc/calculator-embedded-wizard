...
var CF=[0,0,0,0];var DI="No graphics engine bitmap attached to this canvas";var Ed=
"The canvas is already initialized with a graphics engine bitmap";var Ee="ScaleBitmap() operation has been omitted due to the resulting area "+
"being wider or higher than 4069 pixel.";
D.Canvas={Ft:null,Gs:B.wg,CM:0,GK:false,CK:function(){if(this.GK)this.DetachBitmap(
);},AN:function(aArg){this.FO=true;},JV:function(C){if((C[0]<=0)||(C[1]<=0))C=AI;
...
AI;this.FrameDelay=0;this.NoOfFrames=1;}this.Gs=[].concat(AI,this.FrameSize);if(
!!this.bitmap){var dstFrameNr=this.CM;for(this.CM=this.NoOfFrames-1;this.CM>=0;this.
CM--)this.Io(this.Gs,this.Gs,0x00000000,0x00000000,0x00000000,0x00000000,false);
this.CM=dstFrameNr;}}if(!(((A=this.Gs)[0]>=A[2])||(A[1]>=A[3])))this.Gs=CF;},DetachBitmap:
...
function(aBitmap){if(!!this.bitmap)throw new Error(Ed);if(!aBitmap)return this;this.
...
this.bitmap;var dstFrameNo=this.CM;{B.aad(dstBitmap,dstFrameNo,aClip,aDstRect,aEdgeWidth
...
)return;var dstBitmap=this.bitmap;var dstFrameNo=this.CM;{B.rA(dstBitmap,dstFrameNo
...
)orient=180;else if(Je===3)orient=270;var dstFrameNo=this.CM;var dstBitmap=this.
...
);}},K2:function(aClip,aBitmap,aFrameNr,aDstRect,F0,aColorTL,aColorTR,aColorBR,aColorBL
...
dstBitmap=this.bitmap;var srcBitmap=aBitmap.bitmap;var dstFrameNo=this.CM;var srcRect=[
...
B.ab5("%s",Ee);return;}var dstBitmap=this.bitmap;var srcBitmap=aBitmap.bitmap;var
dstFrameNo=this.CM;{B.ab6(dstBitmap,srcBitmap,dstFrameNo,aFrameNr,aClip,left,top
...
this.CM;{B.db(dstBitmap,srcBitmap,dstFrameNr,aFrameNr,aClip,aDstRect,aSrcPos,aColorTL
,aColorTR,aColorBR,aColorBL,aBlend);}},K3:function(aClip,aDstRect,aEdgeWidth,aColorTL
,aColorTR,aColorBR,aColorBL,aBlend){if(!this.bitmap)this.Update();if(!this.bitmap
)return;var dstBitmap=this.bitmap;var dstFrameNo=this.CM;{B.m6(dstBitmap,dstFrameNo
,aClip,aDstRect,aEdgeWidth,aColorTL,aColorTR,aColorBR,aColorBL,aBlend);}},Io:function(
aClip,aDstRect,aColorTL,aColorTR,aColorBR,aColorBL,aBlend){if(!this.bitmap)this.
Update();if(!this.bitmap)return;var dstBitmap=this.bitmap;var dstFrameNo=this.CM;{
...
this.AN(aArg);},_Done:function(){this.CK();this.__proto__=B.ach.Ae;B.ach.Ae._Done.
call(this);},_Mark:function(E){var A;B.ach.Ae._Mark.call(this,E);if((A=this.Ft)&&(
A._cycle!=E))A._Mark(A._cycle=E);},_className:"Graphics::Canvas"};D.N6={Left:0x1
,A4:0x2,Right:0x4,NZ:0x8,Oc:0x10};
