...
EW_CONST_STRING_PRAGMA static const unsigned int _StringsDefault0[] =
{
  ...
  0x8469D349, 0x36533B9C, 0xE4F40A9C, 0x2D16A4D0, 0x9510D4DA, 0x498A44AD, 0x00051647,
  0x8A1E4017, 0x1C52F15D, 0x4D66718B, 0x4A72339B, 0x6674B889, 0x1D108D4C, 0x758AE42A,
  0x16A9DE6D, 0x5C9C7E93, 0xA9E38011, 0xFD2F0525, 0x43223918, 0x9B359DC3, 0xF597EA56,
  0x9C2E8548, 0x1069C95E, 0x1125E721, 0x9A2142FF, 0x24002C31, 0x7C5B2B7C, 0x55F29BCD,
  0x84006D85, 0xA2371854, 0x21138645, 0xD82D04AE, 0x6A90C76B, 0xD8DC7B18, 0x88F2AB71,
  0xB4324D81, 0x696630A8, 0xF0CD14E6, 0xE19C98C6, 0x757B8E90, 0x647F9000, 0xB1B2E7BD,
  0x080D3A9D, 0x00000000
};
...
static const XPoint _Const0003 = { 300, 400 };
...
static const XStringRes _Const0009 = { _StringsDefault0, 0x0087 };
static const XRect _Const000A = {{ -8, -8 }, { 9, 9 }};
static const XRect _Const000B = {{ 0, 0 }, { 1, 1 }};
static const XStringRes _Const000C = { _StringsDefault0, 0x00BA };
...
const XPoint EwScreenSize = { 300, 400 };
  ...
  XPoint aPos )
{
  ...
  if ( aDown && ( _this->cursorTargetView[ EwCheckIndex( aFinger, 10 )] == 0 ))
  {
    ...
    _this->cursorSequelArea[ EwCheckIndex( aFinger, 10 )] = EwMoveRectPos( _Const000A, 
    aPos );
    _this->cursorHittingTime[ EwCheckIndex( aFinger, 10 )] = ticksCount;
    hit = CoreView__CursorHitTest( _this, EwMoveRectPos( _Const000A, aPos ), aFinger, 
  ...
  aFallbackTarget, CoreView aStartView, XSet aRetargetReason )
{
  ...
  hit = CoreView__CursorHitTest( _this, EwMoveRectPos( _Const000A, _this->cursorLastPos[ 
  ...
  if ( !_this->EnableMultiTouch )
  {
    ...
    if ( release && ( _this->state < 16777216 ))
    {
      ...
      if ( root != 0 )
      {
        ...
        hit = CoreView__CursorHitTest( root, EwMoveRectPos( _Const000B, event1->GlobalCurrentPos ), 
