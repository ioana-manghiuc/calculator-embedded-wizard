...
XPoint ViewsWarpView_MapToSourceArea( ViewsWarpView _this, XPoint aPos )
{
  ...
  srcArea = EwIntersectRect2( _this->SourceArea, EwNewRect2Point( _Const0002, _this->bitmapSize ));
...
EW_DEFINE_CLASS( ViewsWarpView, CoreQuadView, inverseMatrix, inverseMatrix, bitmapSize, 
                 bitmapSize, bitmapSize, bitmapSize, "Views::WarpView" )
